...
- Use the existing ./**mocks** folder to mock AWS Amplify and next.js libraries.
- Always import jest globals import { describe, expect, test } from "@jest/globals";
- Use test() instead of it()
- Add tests into **tests** folder in the same folder where the unit to test is located.
